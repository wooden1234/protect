...
from modules.attentions import CBAM
from modules.backbone.mobilenet import MobileNetV4
...
class Decoder(nn.Module):
    def __init__(self,
                 ...
                 # encode_channels=[24,48, 96, 192, 512],
                 decode_channels=48,
        ...
        self.seg_head = MAF(encode_channels[-5], fc_ratio=fc_ratio, dilation=dilation[4], dropout=dropout,
...
class CMTFMNet(nn.Module):
    def __init__(self,
                 ...
                 dropout=0.1,
                 num_classes=2,
                 backbone=MobileNetV4("MobileNetV4HybridMedium")
