...
from modules.backbone.hornet_custom import HoradNet
...
class MAF(nn.Module):
    def __init__(self, dim, fc_ratio, dilation=[3, 5, 7], dropout=0., num_classes=6):
        ...
        self.head = nn.Sequential(SeparableConvBNReLU(dim, dim, kernel_size=3),
                                  ...
                                  Conv(96, num_classes, kernel_size=1))
...
class Decoder(nn.Module):
    def __init__(self,
                 encode_channels=[96, 192, 384, 768],
                 decode_channels=192,
...
class CMTFHNet(nn.Module):
    def __init__(self,
                 encode_channels=[96, 192, 384, 768],
                 decode_channels=192,
                 dropout=0.1,
                 num_classes=2,
                 backbone=HoradNet(in_chans=4,num_classes=2)
