...
from modules.backbone.mobilemamba import MobileMamba_S6
...
class Decoder(nn.Module):
    def __init__(self,
                 encode_channels=[192,192, 384, 448],
                 decode_channels=192,
        ...
        self.p1 = Fusion_1(encode_channels[-4])
...
class CMTFmamba(nn.Module):
    def __init__(self,
                 encode_channels=[192,192, 384, 448],
                 decode_channels=192,
                 dropout=0.1,
                 num_classes=2,
                 backbone=MobileMamba_S6(num_classes=2)
        ...
        self.CBAM = CBAM.CBAM(in_chans=2)
