...
from modules.backbone.overlock import overlock_xt
...
class MAF(nn.Module):
    def __init__(self, dim, fc_ratio, dilation=[3, 5, 7], dropout=0., num_classes=6):
        ...
        self.head = nn.Sequential(SeparableConvBNReLU(dim, dim, kernel_size=3),
                                  ...
                                  Conv(56, num_classes, kernel_size=1))
...
class Decoder(nn.Module):
    def __init__(self,
                 encode_channels=[56, 112, 340, 420],
                 decode_channels=112,
...
class CMTFover(nn.Module):
    def __init__(self,
                 encode_channels=[56, 112, 340, 420],
                 decode_channels=112,
                 dropout=0.1,
                 num_classes=2,
                 backbone=overlock_xt()
