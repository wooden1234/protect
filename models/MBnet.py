...
class MobileMambaModule(torch.nn.Module):
    def __init__(self, dim, global_ratio=0.25, local_ratio=0.25,
        ...
        self.CBAM =CBAM(int(dim*(1-global_ratio-local_ratio)))
...
class MBnet(torch.nn.Module):
    def __init__(self,
        ...
        self.backbone = backbone("MobileNetV4ConvLarge")
        ...
        self.last_conv = nn.Sequential(nn.Conv2d(embed_dim[3], embed_dim[3], kernel_size=3, stride=1, padding=1, bias=False),
...
class MBnet_1(torch.nn.Module):
    def __init__(self,
        ...
        self.last_conv = nn.Sequential(nn.Conv2d(embed_dim[2], embed_dim[2], kernel_size=3, stride=1, padding=1, bias=False),
